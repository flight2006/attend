...
<div class="sidebar" id="sidebar">
	<ul class="nav nav-list">
		<li <c:if test="${sidebar=='students'}">class="active"</c:if> >
			<a href="<%=request.getContextPath()%>/manager/employee">
				<i class="icon-user"></i>
				<span class="menu-text"> 员工列表 </span>
			</a>
		</li>
		<li <c:if test="${sidebar=='classes'}">class="active"</c:if> >
			<a href="<%=request.getContextPath()%>/manager/department">
				<i class="icon-list-alt"></i>
				<span class="menu-text"> 部门列表 </span>
			</a>
		</li>
		<li <c:if test="${sidebar=='exams'}">class="active"</c:if> >
			<a href="<%=request.getContextPath()%>/manager/attend">
				<i class="icon-file"></i>
				<span class="menu-text"> 考勤列表 </span>
			</a>
		</li>
