			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						...
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							<label for="form-field-8"> 管理 <b>${cls.name}</b> 员工（主管：${cls.manager }） </label>
							<br>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<button class="btn btn-mini btn-danger" onclick="if(window.confirm('确认删除员工${student.name}？')==true)location.href='<%=request.getContextPath() %>/manager/deletestudent?studentid=${student.id}&departmentid=${student.department_id}'"><i class="icon-remove"></i>删除</button>
										</td>
									</tr>
								</c:forEach>
								</tbody>
