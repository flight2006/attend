		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<button class="btn btn-mini btn-primary"  align="right" onclick="location.href='<%=request.getContextPath() %>/manager/MenuManager'" ><i class="icon-user"></i>&nbsp;公众号自定义菜单更新</button>
								  ...
								  <tbody>
								  	<c:forEach items="${messageList}"  var="message"   varStatus="st" >
								  		...
								  		<td>${message.content}</td>
											<td>
												<button class="btn btn-mini btn-primary" onclick="location.href='<%=request.getContextPath() %>/manager/messagesenderrelate?weixinid=${message.fromUserName}'" ><i class="icon-user"></i>&nbsp;微信ID关联员工</button>
											</td>
								  		</tr>
								  	</c:forEach>
								  </tbody>
