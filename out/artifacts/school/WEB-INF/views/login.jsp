...
<head>
	...
	<body class="login-layout" style="background-image:url(<%=request.getContextPath()%>/assets/images/background.jpg);background-position:center; background-repeat:repeat-y">
			<br><br>
										...
										<div id="login-box" class="login-box visible widget-box no-border">
											<div class="widget-body">
												<div class="widget-main">
													...
													<span class="bigger-110">微管理(MicroManage)</span>
													</div>
